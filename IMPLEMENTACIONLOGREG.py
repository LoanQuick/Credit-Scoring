...
# df = pd.read_excel('Credit-Scoring/estadistical.xlsx', sheet_name='Sheet1')
...
# # Scale the data
# X_scaled = preprocessing.scale(train_x_encoded)

train_y = train['Receive_NotReceiveCredit'].to_frame()

test_x = test[h11]
X_scaled2 = preprocessing.scale(test_x)
# train_x_encoded2 = pd.get_dummies(test_x)

# # Scale the data
# X_scaled2 = preprocessing.scale(train_x_encoded2)
